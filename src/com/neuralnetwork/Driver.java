...
public class Driver {
	...
	public void printHeading(int epochNumber){
		System.out.println("\n______________________________________________________Epoch #"+epochNumber+"_____________________________________________________");    
		System.out.println("\n    w1   |    w2      |    x1   |    x2   | Target R|  Result |  error  |   Wghted Sum | adjusted w1 | adjusted w2");
		System.out.println("\n-------------------------------------------------------------------------------------------------------------------");
	}
